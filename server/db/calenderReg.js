...
exports.register = (req, res) => {
    pool.query(`insert details of Calender (name, email, description, date, time) values ('${req.body.name}','${req.body.email}', '${req.body.description}', '${req.body.date}', '${req.body.time}')`, (err, _) => {
        if (err) {
