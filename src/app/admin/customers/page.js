        ...
        <div className='bg-gray-400 min-h-screen'>
            ...
            <div className='p-4'>
                <div className='w-full m-auto p-4 border rounded-lg bg-gray-50 overflow-y-auto'>
                    ...
                    <ul>
                        {data.map((order, id) => (
                            <li key={id} className='bg-red-100 hover:bg-red-400 rounded-lg my-3 p-2 grid md:grid-cols-4 sm:grid-cols-3 grid-cols-2 items-center justify-between cursor-pointer'>
